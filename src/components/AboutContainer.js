  ...
  return (
    <Container style={{ padding: '0 10px' }} maxWidth={false}>
      ...
      >
        ...
        <Typography paragraph>
          Begrudgingly, this also includes making these views compliant in
          older, less modern browsers. My work at Sharecare also includes
          working with NodeJS servers when necessary.
        </Typography>
        <Typography paragraph>
